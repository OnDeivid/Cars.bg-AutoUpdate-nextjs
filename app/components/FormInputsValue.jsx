    ...
    return (
        <>
            ...
            <div>
                <label
                    htmlFor="carsEmail"
                    className={`block mb-2 text-sm font-medium ${carsEmail_B ? 'text-gray-200' : 'text-white'} ${carsEmail_B ? '' : 'dark:text-gray-200'}`}
                >
            ...
            <div>
                <label
                    htmlFor="phoneNumber"
                    className={`block mb-2 text-sm font-medium text-gray-200 ${phoneNumber_B ? 'dark:text-gray-200' : 'dark:text-white'}`}
                >
                    Телефонен Номер
                </label>
                <input
            ...
            <div>
                <label
                    htmlFor="password"
                    className={`block mb-2 text-sm font-medium text-gray-900 ${carsEmail_B ? 'dark:text-gray-200' : 'dark:text-white'}`}
                >
            ...
            <div>
                <label
                    ...
                    className={`block mb-2 text-sm font-medium text-gray-200 ${carsEmail_B ? 'dark:text-gray-200' : 'dark:text-white'}`}
                >
                    Потвърди паролата
                </label>
                <input
