...
export default function UserImage({ image }) {
    ...
    return (
        <div>
            <Image id="avatarButton" type="button" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start" className="w-7 h-7 rounded-full cursor-pointer" src={image} width={7} height={7} alt="User dropdown" />
